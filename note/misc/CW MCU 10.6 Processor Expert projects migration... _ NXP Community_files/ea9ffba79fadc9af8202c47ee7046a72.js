...
*/ defineStatic({"endpoint":"/metadata/locales/available","name":$s[900],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/metadata/locales/supported","name":$s[901],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/metadata/objects/{name}/values","queryParams":[$s[95],$s[38],$s[421],$s[94],$s[431]],"name":$s[888],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/places/relatedtocontent","queryParams":[$s[328],$s[244],$s[38],$s[27],$s[94]],"name":$s[890],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/places/relatedtocontent/count","queryParams":[$s[244]],"name":$s[912],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/rewards/leaderboard/overall","queryParams":[$s[107],$s[319],$s[219],$s[94],$s[312]],"name":$s[903],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/missionLeaderboard/{missionId}","queryParams":[$s[319],$s[219],$s[94],$s[312]],"name":$s[896],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/modals/missions/{badgeId}/{userId}","queryParams":[$s[94]],"name":$s[921],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/modals/quests/{badgeId}/{userId}","queryParams":[$s[94]],"name":$s[915],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/reputation/{userId}","queryParams":[$s[94]],"name":$s[885],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/modals/strategies/{badgeId}/{userId}","queryParams":[$s[94]],"name":$s[922],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/userBadgesLeaderboard/{badgeId}","queryParams":[$s[107],$s[319],$s[219],$s[30],$s[94],$s[312]],"name":$s[905],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/handoutBadgesAndPoints","name":$s[919],"httpMethod":$s[0]});
/**
 * Defines a static updater method
...
*/ defineStatic({"endpoint":"/achievements/saveLeaderboardImage","queryParams":[$s[94]],"name":$s[893],"httpMethod":$s[12]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/availableMissions","queryParams":[$s[94]],"name":$s[891],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/connectedUserHandoutBadges","queryParams":[$s[94]],"name":$s[918],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/userBadgesStreamActivity","queryParams":[$s[368],$s[94]],"name":$s[914],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/userHandoutBadges","queryParams":[$s[94],$s[125]],"name":$s[892],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/achievements/userPanel/{userId}/expertBadges","name":$s[899],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"optionsInterceptor":$s[522],"endpoint":"/collaborations/{uri}/interactions/{interactionID}","queryParams":[$s[95],$s[518],$s[38],$s[94]],"name":$s[924],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"optionsInterceptor":$s[522],"endpoint":"/collaborations/{uri}/interactions","queryParams":[$s[95],$s[87],$s[38],$s[36],$s[94]],"name":$s[923],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"optionsInterceptor":$s[522],"endpoint":"/collaborations/{uri}/participants/{userID}","name":$s[894],"httpMethod":$s[74]});
/**
 * Defines a static updater method
...
*/ defineStatic({"optionsInterceptor":$s[522],"endpoint":"/solutions/supportCenter/banner","queryParams":[$s[94]],"name":$s[904],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"optionsInterceptor":$s[522],"endpoint":"/solutions/supportCenter/blocks","queryParams":[$s[94]],"name":$s[897],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"optionsInterceptor":$s[522],"endpoint":"/solutions/supportCenter/channels","queryParams":[$s[94]],"name":$s[911],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/solutions/supportCenter/categories","name":$s[898],"httpMethod":$s[0]});
/**
 * Defines a static updater method
 * @param supportCenterSection {$$paramType} the object to create.
 */ /*
...
*/ defineStatic({"endpoint":"/solutions/supportCenter/publish/{published}","name":$s[887],"httpMethod":$s[12]});
/**
 * Defines a static updater method
...
*/ defineStatic({"paramType":$s[886],"optionsInterceptor":$s[522],"endpoint":"/solutions/supportCenter/sections/{sectionID}","queryParams":[$s[94]],"name":$s[874],"httpMethod":$s[1],"validate":true});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"optionsInterceptor":$s[522],"endpoint":"/extstreams/{id}","queryParams":[$s[94]],"name":$s[906],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/people/{personID}/expertise/pending","name":$s[916],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/people/{personID}/expertise/top","queryParams":[$s[328],$s[38],$s[94]],"name":$s[889],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/people/expertise/{tagName}","queryParams":[$s[328],$s[38],$s[94]],"name":$s[909],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/people/expertise","queryParams":[$s[328],$s[38],$s[177],$s[94]],"name":$s[917],"httpMethod":$s[0]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"endpoint":"/people/{personID}/expertise/endorsers","queryParams":[$s[328],$s[38],$s[177],$s[94]],"name":$s[910],"httpMethod":$s[0]});
/**
 * Defines a static updater method
 * @param person {$$paramType} the object to create.
 */ /*
...
*/ defineStatic({"paramType":$s[689],"endpoint":"/people/{personID}/expertise/endorse/{tagName}","name":$s[907],"httpMethod":$s[1],"validate":true});
/**
 * Defines a static updater method
 * @param obj {$$paramType} the object to destroy.
 */ /*
...
*/ defineStatic({"endpoint":"/people/{personID}/expertise/{tagName}","name":$s[902],"httpMethod":$s[74]});
/**
 * Defines a static updater method
 * @param obj {$$paramType} the object to destroy.
 */ /*
...
*/ defineStatic({"endpoint":"/people/{personID}/expertise/","queryParams":[$s[177]],"name":$s[908],"httpMethod":$s[74]});
/**
 * Defines a static updater method
 * @param obj {$$paramType} the object to destroy.
 */ /*
...
*/ defineStatic({"endpoint":"/people/{personID}/expertise/endorse","queryParams":[$s[177]],"name":$s[884],"httpMethod":$s[74]});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"ext":$s[583],"endpoint":"/eventTypes","queryParams":[$s[95],$s[328],$s[38],$s[94]],"name":$s[913],"httpMethod":$s[0],"version":"3"});
/**
 * Defines a static getter method which takes a single options argument
 * @param opts {Object} Options object may contain the following properties:
 *     
...
*/ defineStatic({"ext":$s[583],"endpoint":"/eventTypes/{eventTypeID}","queryParams":[$s[94]],"name":$s[913],"httpMethod":$s[0],"version":"3"});
/**
 * Defines a static updater method
 ...
 */
defineClass($s[895], osapi.jive.corev3.AbstractObject, {"type":$s[627]}, []);
 ...
 */ defineInstanceMethod({"methodName":$s[544],"className":$s[895],"resourceName":$s[437],"httpMethod":$s[0],"signature":$s[105]});
/**
 * Adds a dynamic convenience method to osapi.jive.corev3.extstreams.ExternalStreamInstance
 * to simplify use of the privateprops resource.
 ...
 */ defineInstanceMethod({"methodName":$s[605],"className":$s[895],"resourceName":$s[437],"httpMethod":$s[12],"signature":"data, params","queryParams":[]});
/**
 ...
 */
defineClass($s[886], osapi.jive.corev3.AbstractObject, {"type":$s[621]}, [{"name":$s[66]}]);
 ...
 */ defineInstanceMethod({"methodName":$s[141],"className":$s[886],"resourceName":$s[25],"httpMethod":$s[74],"signature":""});
/**
 * Adds a dynamic convenience method to osapi.jive.corev3.solutions.supportcenter.Section
 * to simplify use of the self resource.
 * This method will execute a GET for self resources
 ...
 */ defineInstanceMethod({"methodName":$s[5],"className":$s[886],"resourceName":$s[25],"httpMethod":$s[0],"signature":$s[105],"queryParams":[$s[94]]});
/**
 * Adds a dynamic convenience method to osapi.jive.corev3.solutions.supportcenter.Section
 * to simplify use of the self resource.
 * This method will execute a PUT for self resources
 ...
 */ defineInstanceMethod({"methodName":$s[124],"className":$s[886],"resourceName":$s[25],"httpMethod":$s[1],"signature":$s[105],"queryParams":[$s[94]]});
/**
