...
var community=false;
for(ss=0;ss<10;ss++){
	if(scripts[ss].src.indexOf("community.nxp.com")>-1){
		community=true;
		break;
	}
}*/
...
var elqSiteID='';
if(document.domain == "www.nxp.com" || document.domain == "cache.nxp.com" || document.domain == "style.nxp.com" || document.domain == "community.nxp.com"){
	elqSiteID='1764';
}else if(document.domain == "www.freescale.com" || document.domain == "cache.freescale.com" || document.domain == "styles.freescale.com"){
	elqSiteID='1764';
}else{
	elqSiteID='2716';
}
