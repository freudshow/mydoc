...
S CODE VERSION: H27.5
*/

//var counter = 0;
var sc_shortURLDomain = "m-uat.freescale.com";
//var internalDomainList = 'javascript:,www.freescale.com,freescale.com.cn,freescale.co.jp,contact.freescale.com,contact.nxp.com,cache.freescale.com,community.freescale.com,community.nxp.com,uat.freescale.com,cache-uat.freescale.com,community-uat.freescale.com,*.freescale.net,freescale.co.kr,getregisterednow.com,images.freescale.com,media.freescale.com,ir.freescale.com,investors.freescale.com,scdev-15.isys.intraware.com,freescaleuat.flexnetoperations.com,freescale.flexnetoperations.com,iottour.freescaleforms.com,iot.freescale.com,fslwpbt.de,blogs.freescale.com,vod.freescale.com,video.freescale.net,esdhttpuat.flexnetoperations.com,freescaleesdtest.flexnetoperations.com,freescaleesd.flexnetoperations.com,http.flexnetoperations.com,ftf.freescaleforms.com,preview-test.freescale.net,preview.freescale.net,ftf.freescale.com,az84ap80.am.freescale.net,fsls.co,m-uat.freescale.com,freescale.jiveon.com,ftf-test-brazil.freescale.net,az84ap47.am.freescale.net,az84ap80.am.freescale.net,az84ap89.am.freescale.net,localhost,www.nxp.com,cache.nxp.com,cached-files.qualcomm.com,cached-files-uat.qualcomm.com,contact-freescale-com.p01.elqsandbox.com,nxpuat.flexnetoperations.com,iot-test-china.freescale.net,iot-cn.nxp.com,investors.nxp.com,az84wfm05c.am.freescale.net,events.nxp.com,training.nxp.com,nww.teamsite-test.nxp.com,nww.preview-test.nxp.com,nww.teamsite-dev.nxp.com,nww.preview-dev.nxp.com,az84ap84.am.freescale.net,blog.nxp.com,phx.corporate-ir.net,disti.nxp.com,full-nxpcommunity.,7sdev-nxpcommunity.,nxpcommunity.,dev-sandbox.qualcomm.com,dev-sandbox.qualcomm.cn,ppe.qualcomm.com,ppe.qualcomm.cn,www.qualcomm.com,www.qualcomm.cn,qualcommuat.flexnetoperations.com,qualcomm.flexnetoperations.com,qualcommesdtest.flexnetoperations.com,qualcommesd.flexnetoperations.com';
var internalDomainList = 'javascript:,www.freescale.com,freescale.com.cn,freescale.co.jp,contact.freescale.com,contact.nxp.com,cache.freescale.com,community.freescale.com,community.nxp.com,uat.freescale.com,cache-uat.freescale.com,community-uat.freescale.com,*.freescale.net,freescale.co.kr,getregisterednow.com,images.freescale.com,media.freescale.com,ir.freescale.com,investors.freescale.com,scdev-15.isys.intraware.com,freescaleuat.flexnetoperations.com,freescale.flexnetoperations.com,iottour.freescaleforms.com,iot.freescale.com,fslwpbt.de,blogs.freescale.com,vod.freescale.com,video.freescale.net,esdhttpuat.flexnetoperations.com,freescaleesdtest.flexnetoperations.com,freescaleesd.flexnetoperations.com,http.flexnetoperations.com,ftf.freescaleforms.com,preview-test.freescale.net,preview.freescale.net,ftf.freescale.com,az84ap80.am.freescale.net,fsls.co,m-uat.freescale.com,freescale.jiveon.com,ftf-test-brazil.freescale.net,az84ap47.am.freescale.net,az84ap80.am.freescale.net,az84ap89.am.freescale.net,localhost,www.nxp.com,cache.nxp.com,contact-freescale-com.p01.elqsandbox.com,nxpuat.flexnetoperations.com,iot-test-china.freescale.net,iot-cn.nxp.com,investors.nxp.com,az84wfm05c.am.freescale.net,events.nxp.com,training.nxp.com,nww.teamsite-test.nxp.com,nww.preview-test.nxp.com,nww.teamsite-dev.nxp.com,nww.preview-dev.nxp.com,az84ap84.am.freescale.net,blog.nxp.com,phx.corporate-ir.net,disti.nxp.com,full-nxpcommunity.,7sdev-nxpcommunity.,nxpcommunity.,dev-sandbox.qualcomm.com,dev-sandbox.qualcomm.cn,www.qualcomm.com,ppe.qualcomm.com';//Comment after 4_10 release and uncomment the above line
//Specify the Report Suite ID(s) to track here 
var s_account='freescaledev';
if( document.URL.indexOf('www.freescale.com')>-1  
 || document.URL.indexOf('freescale.com.cn')>-1 || document.URL.indexOf('freescale.co.jp')>-1 || document.URL.indexOf('contact.freescale.com')>-1 || document.URL.indexOf('community.freescale.com')>-1
 || document.URL.indexOf('media.freescale.com')>-1 || document.URL.indexOf('ir.freescale.com')>-1 || document.URL.indexOf('investors.freescale.com')>-1||document.URL.indexOf('iot.freescale.com')>-1||document.URL.indexOf('blogs.freescale.com')>-1
 || document.URL.indexOf('freescale.flexnetoperations.com')>-1||document.URL.indexOf('freescaleesd.flexnetoperations.com')>-1||document.URL.indexOf('ftf.freescale.com')>-1||document.URL.indexOf('www.nxp.com')>-1||document.URL.indexOf('community.nxp.com')) 
{ s_account='freescaleprod';  }
if(document.URL.indexOf('uat.freescale.com')>-1 || document.URL.indexOf('freescaleuat.flexnetoperations.com')>-1 ||document.URL.indexOf('iottour.freescaleforms.com')>-1||document.URL.indexOf('fslwpbt.de')>-1
  ||document.URL.indexOf('freescaleesdtest.flexnetoperations.com')>-1||document.URL.indexOf('ftf.freescaleforms.com')>-1||document.URL.indexOf('freescale.jiveon.com')>-1||document.URL.indexOf('ftf-test-brazil.freescale.net')>-1 || document.URL.indexOf('http://blogs-test.am.freescale.net')>-1)
  s_account='freescaleuat';
if(document.URL.indexOf('uat.freescale.com')>-1)
   s_account='freescaledev';
/* Logic for environment to s_account mapping */
if(window.sc_env){
  switch(sc_env){
    case "prod": s_account='freescaleprod'; break;
    case "dev": s_account='freescaledev'; break;
    case "uat": s_account='freescaleuat'; break;
    case "test": s_account='freescaleuat'; break;
    }
  } 
...
s.linkInternalFilters='javascript:,www.freescale.com,freescale.com.cn,freescale.co.jp,contact.freescale.com,contact.nxp.com,cache.freescale.com,community.freescale.com,community.nxp.com,uat.freescale.com,cache-uat.freescale.com,community-uat.freescale.com,*.freescale.net,freescale.co.kr,getregisterednow.com,images.freescale.com,media.freescale.com,ir.freescale.com,investors.freescale.com,scdev-15.isys.intraware.com,freescaleuat.flexnetoperations.com,freescale.flexnetoperations.com,iottour.freescaleforms.com,iot.freescale.com,fslwpbt.de,blogs.freescale.com,vod.freescale.com,video.freescale.net,esdhttpuat.flexnetoperations.com,freescaleesdtest.flexnetoperations.com,freescaleesd.flexnetoperations.com,http.flexnetoperations.com,ftf.freescaleforms.com,preview-test.freescale.net,preview.freescale.net,ftf.freescale.com,az84ap80.am.freescale.net,fsls.co,m-uat.freescale.com,freescale.jiveon.com,ftf-test-brazil.freescale.net,az84ap47.am.freescale.net,az84ap80.am.freescale.net,az84ap89.am.freescale.net,localhost,www.nxp.com,cache.nxp.com,cached-files.qualcomm.com,cached-files-uat.qualcomm.com,contact-freescale-com.p01.elqsandbox.com,nxpuat.flexnetoperations.com,iot-test-china.freescale.net,iot-cn.nxp.com,investors.nxp.com,az84wfm05c.am.freescale.net,events.nxp.com,training.nxp.com,nww.teamsite-test.nxp.com,nww.preview-test.nxp.com,nww.teamsite-dev.nxp.com,nww.preview-dev.nxp.com,az84ap84.am.freescale.net,blog.nxp.com,phx.corporate-ir.net,disti.nxp.com,full-nxpcommunity.,7sdev-nxpcommunity.,nxpcommunity.,dev-sandbox.qualcomm.com,dev-sandbox.qualcomm.cn';
s.linkLeaveQueryString=true;
s.linkTrackVars='channel,prop1,prop2,prop3,prop6,prop7,prop8,prop9,prop10,prop11,prop13,prop14,prop16,prop18,prop21,prop23,prop24,prop25,prop26,prop27,prop31,prop42,prop74,prop75,eVar1,eVar2,eVar4,eVar5,eVar6,eVar15,eVar16,eVar17,eVar18,eVar19,eVar20,eVar21,eVar34,eVar35,eVar38,eVar39,eVar48,eVar51,eVar52,eVar53,eVar67,eVar68,list1';
s.linkTrackEvents='None';
s.linkTrackVarsTemp = s.linkTrackVars;
...
s.visitorNamespace = "freescale"
s.trackingServer = "freescale.d2.sc.omtrdc.net";
s.trackingServerSecure = "";

/* Uncomment the following if 1st Party SSL Certificate has been installed */
//s.trackingServer='metrics.freescale.com'; 
//s.trackingServerSecure='smetrics.freescale.com'; 
...
/* Setting periodicity to identify the correct domain for cookie setting - Does not apply to s_vi*/
...
function s_doPlugins(s) 
{
  ...
  //s.eVar85 = clickTaleValues;
  /* Ensure s.events exists */
  s.events = s.events ? s.events : '';
  if(s.pageURL){
    s.pageURLTemp = s.pageURL;
    s.pageURL = "";
    delete s.pageURL;
  }
  ...
  /* Automate Campaign Tracking Code Extraction based on the cid parameter*/
	if(!s.campaign){
		...
		if(s.campaign.indexOf('social') > -1){
		  if(s.campaign.indexOf('social') == 0)
			s.eVar59 = s.campaign;
		  }
	  }

	//FTF Takeover Wrapper - Remove Post Event
if(typeof digitalData.pageInfo=='undefined' || typeof digitalData.pageInfo.pageLoadRule=='undefined' || digitalData.pageInfo.pageLoadRule!='FTFTakeover'){
		/* Eloqua Integration */
		s.eVar38 = s.getQueryParam('elq_cid');
		s.eVar39 = s.getQueryParam('elq_mid');
		if(s.eVar39 && !s.campaign) 
			s.campaign = "eml_elq_"+s.eVar39;
	  /* Automate Internal Campaign Code Extraction based on icid parameter*/
		if(!s.eVar3)
			s.eVar3=s.getQueryParam('icid');
	}
	//End of FTF Takeover Wrapper - Remove Post Event
	
	/* Get value once per visit for s.campaign */
	s.campaign=s.getValOnce(s.campaign,'s_campaign',0);//Comment after 4_10 release
  ...
  /* copy purchase event into event35 */
  ...
  if(typeof digitalData !='undefined' && typeof digitalData.pageInfo !='undefined' && typeof digitalData.pageInfo.pageName != 'undefined' && digitalData.pageInfo.pageName != ""){
	  s.prop6=s.getPreviousValue(digitalData.pageInfo.pageName,'gpv','');
  }
  else{
	  s.prop6=s.getPreviousValue(s.pageName,'gpv','');
  }
  if(typeof digitalData.ignorePageLoad != 'undefined'){
    if(digitalData.ignorePageLoad){
      digitalData.ignorePageLoad = false;
      digitalData.pageInfo.previousPage = s.prop6;
      s.abort=true;
    }else if(typeof digitalData.pageInfo.previousPage != 'undefined' && digitalData.pageInfo.previousPage != ""){
      s.prop6 = digitalData.pageInfo.previousPage;
      digitalData.pageInfo.previousPage = "";
    }   
  }
  ...
  /* Commented 9/27 to confirm if package page issue is resolved. 
  if (s.prop6)
...
/* Automate Finding Method eVar */
  ...
  else if( (document.referrer.indexOf('iot.freescale.com')>-1&&document.URL.indexOf('iot.freescale.com')==-1) || (document.referrer.indexOf('iottour.freescaleforms.com')>-1&&document.URL.indexOf('iottour.freescaleforms.com')==-1)
			|| (document.referrer.indexOf('iot-test-china.freescale.net')>-1&&document.URL.indexOf('iot-test-china.freescale.net/')==-1) || (document.referrer.indexOf('iot-cn.nxp.com')>-1&&document.URL.indexOf('iot-cn.nxp.com')==-1))
  {
    s.eVar1='IoT Tour';
    s.eVar2='non-search';
  }
  else if((document.referrer.indexOf('blogs.freescale.com')>-1&&document.URL.indexOf('blogs.freescale.com')==-1) || (document.referrer.indexOf('fslwpbt.de')>-1&&document.URL.indexOf('fslwpbt.de')==-1))
  {
    if(s.events.indexOf('event11')==-1&&s.events.indexOf('event13')==-1&&s.events.indexOf('event34')==-1&&s.events.indexOf('event31')&&s.events.indexOf('event32')&&s.events.indexOf('event31')){
      s.eVar1='Freescale Blogs';
      s.eVar2='non-search';
    }
  }
  else if((document.referrer.indexOf('blog.nxp.com')>-1&&document.URL.indexOf('blog.nxp.com')==-1) || (document.referrer.indexOf('blogs-test.am.freescale.net')>-1&&document.URL.indexOf('blogs-test.am.freescale.net/')==-1))
  {
    if(s.events.indexOf('event11')==-1&&s.events.indexOf('event13')==-1&&s.events.indexOf('event34')==-1&&s.events.indexOf('event31')&&s.events.indexOf('event32')&&s.events.indexOf('event31')){
      s.eVar1='NXP Blogs';
      s.eVar2='non-search';
  ...
  else if((document.referrer.indexOf('ftf.freescale.com')>-1&&document.URL.indexOf('ftf.freescale.com')==-1) || (document.referrer.indexOf('ftf.freescaleforms.com')>-1&&document.URL.indexOf('ftf.freescaleforms.com')==-1)){
    if(s.events.indexOf('event11')==-1&&s.events.indexOf('event13')==-1&&s.events.indexOf('event34')==-1&&s.events.indexOf('event31')&&s.events.indexOf('event32')&&s.events.indexOf('event31')){
      s.eVar1='FTF Microsite';
      s.eVar2='non-search';
    }
  }
  /** CROSS CHECK MOBILE APP SPECIFIC CODE PLACE HOLDER **/
  else if(s.eVar1)
  {
    /* Use the value of eVar1 from page */
    s.eVar3='non-internal campaign';
  }
  else if(s.eVar7&&s.eVar7!='non-cross sell')
  {
    ...
    s.eVar2='non-search';
    s.eVar3='non-internal campaign';
  }else if(!s.eVar1 && internalFlag){
    s.eVar1='browse';
    if(!s.eVar2) s.eVar2='non-search';
    s.eVar3='non-internal campaign';    
  }
  else if(!s.eVar1){
    if(!s.eVar2) s.eVar2='non-search';
  ...
  /* Historical Eloqua contact ID check */
  if(!s.eVar38){
    try{
      if(typeof(window.elq_contactidNew) != "undefined"){
        s.eVar38 = parseInt(window.elq_contactidNew.replace("CFSSC",""));
        }
      } catch(e){}
    }
  
  /* Hierarchy variables */ 
  s.hier1 = 'D=ch+"|"+c2+"|"+c3+"|"+c8+"|"+c9+"|"+c10+"|"+c11';
  s.hier2 = 'D=ch+"|"+v18+"|"+c2+"|"+c3+"|"+c8+"|"+c9+"|"+c10+"|"+c11';
    
  /* Prop16 cleanup */
  if(s.prop16) 
    if(s.prop16.indexOf("page:D=pageName") > -1)
      s.prop16="page:"+"D=pageName";
  
  var isExitLink = false;
  var isDownload = false;
  if(typeof s.events != 'undefined' && s.events.indexOf("event15") > -1)
    isDownload = true;
  ...
  if(linkObject){
    ...
    //Custom Code, identifies exit links for browser back button selection
    if(typeof(s.linkType) != "undefined" && s.linkType == ""){
      var lnkobjecturl = linkObject.href.split('?')[0]
      var dom_array = s.linkInternalFilters.split(',');
      var dom_len = dom_array.length;
			s.linkType = "e";
      for (i = 0; i < dom_len; i++) {
      if(lnkobjecturl.indexOf(dom_array[i])>-1){
        s.linkType = "";
        break;
      }
      }	
    }
    isExitLink = (typeof(s.linkType) != "undefined" && s.linkType == "e");
    try{
    s.linkTrackVars = s.linkTrackVarsTemp;	
    // form abandon - prop17, remove eVar16
    if(linkObject.href.indexOf("javascript:") > -1){
      if(typeof(s.linkType) != "undefined"){
        if(s.linkType == "e"){
        s.prop16="";
        s.eVar16="Custom JS Function";
          }
        }
      }
    else {
      if(typeof(s.linkType) != "undefined"){
        if(s.linkType == "e"){
          s.prop16="exit:"+linkObject.href;
          s.events = s.eVar1 = s.eVar63 = "";
          s.eVar16=linkObject.href;
		  ...
		  /*Comment for 4_11 release, uncomment after release
		  //Added for Day 1 to ensure exit links go to NXP Report Suite - 1/26/2018
          s.un = s.fun = "freescaleuat";
          //Added for Day 1 to ensure exit links set correct variables for NXP Report Suite - 1/26/2018
		  if(typeof digitalData!='undefined'&&typeof digitalData.pageInfo!='undefined'){
			  if(digitalData.pageInfo.pageName!='undefined'){s.pageName = s.prop21 = s.eVar48 = digitalData.pageInfo.pageName;}
			  
			  if(digitalData.pageInfo.siteSection1!='undefined'){s.channel = digitalData.pageInfo.siteSection1;}
			  else{s.channel = "";}
			  
			  if(digitalData.pageInfo.siteSection2!='undefined'){s.prop2 = digitalData.pageInfo.siteSection2;}
			  else{s.prop2 = "";}			  
			  
			  if(digitalData.pageInfo.siteSection3!='undefined'){s.prop3 = digitalData.pageInfo.siteSection3;}
			  else{s.prop3 = "";}		
			  
			  if(digitalData.pageInfo.siteSection4!='undefined'){s.prop8 = digitalData.pageInfo.siteSection4;}
			  else{s.prop8 = "";}					  

			  if(digitalData.pageInfo.siteSection5!='undefined'){s.prop9 = digitalData.pageInfo.siteSection5;}
			  else{s.prop9 = "";}
			  
			  if(digitalData.pageInfo.siteSection6!='undefined'){s.prop10 = digitalData.pageInfo.siteSection6;}
			  else{s.prop10 = "";}
			  
			  if(digitalData.pageInfo.siteSection7!='undefined'){s.prop11 = digitalData.pageInfo.siteSection7;}
			  else{s.prop11 = "";}
			  
			  if(digitalData.pageInfo.localTitle!='undefined'){s.eVar19 = digitalData.pageInfo.localTitle;}
			  else{s.eVar19 = "";}

			  if(digitalData.pageInfo.nodeID!='undefined'){s.eVar20 = digitalData.pageInfo.nodeID;}
			  else{s.eVar20 = "";}
			  
			  if(digitalData.pageInfo.pageCodeID!='undefined'){s.eVar21 = digitalData.pageInfo.pageCodeID;}
			  else{s.eVar21 = "";}
			  s.eVar34 = "D=c13"
		  }*/
    ...
    if(linkObject.getAttribute('data-sc-noexit') && typeof(s.linkType) != "undefined"){
      if(linkObject.getAttribute('data-sc-noexit') == "true" && s.linkType == "e"){
        s.abort = true;
        s.manageVars("eVar16","prop16",1);
        }
      }
	  
	//eVar1 exit link contentfinding tracking  
    if(linkObject.getAttribute('data-content-finding')){
      s.eVar1 = linkObject.getAttribute('data-content-finding');
      s.linkTrackVars=s.apl(s.linkTrackVars,'eVar1',',',2);
      } else if(isExitLink && typeof getContentFinding == 'function'){
        if(linkObject.getAttribute("class")!=null){
        	if(linkObject.getAttribute("class").indexOf("footer-social-item") > -1 || linkObject.getAttribute("class").indexOf("SocialLink") > -1){
          	s.eVar="footer";
          }else{
        		s.eVar1 = getContentFinding(document.URL,linkObject.href, true)
          }
        }else{
       		s.eVar1 = getContentFinding(document.URL,linkObject.href, true);	  
      	}
      }
	//eVar63 exit link subcontentfinding tracking  
   
      if(linkObject.getAttribute('data-content-subfinding')){
    	s.eVar63 = linkObject.getAttribute('data-content-subfinding');
      s.linkTrackVars=s.apl(s.linkTrackVars,'eVar63',',',2);
      setAdobeCookie('subContentFinding','');
      }else if(isExitLink){
        if(linkObject.getAttribute("class")!=null){
        	if(linkObject.getAttribute("class").indexOf("footer-social-item") > -1 || linkObject.getAttribute("class").indexOf("SocialLink") > -1){
          	s.eVar63 = "footer - social media";
            s.linkTrackVars=s.apl(s.linkTrackVars,'eVar63',',',2);
          }else{
        		s.eVar63 = getSubContentFinding($(linkObject));
						s.linkTrackVars=s.apl(s.linkTrackVars,'eVar63',',',2);          	
          }
        }else{
        	s.eVar63 = getSubContentFinding($(linkObject));
    ...
    if(window.sc_ignoreexits && typeof(s.linkType) != "undefined"){
      if(window.sc_ignoreexits == true && s.linkType == "e") {
        s.abort = true;
        s.manageVars("eVar16","prop16",1);
        }
      }
  ...
  if(isDownload){
    removeAdobeCookie("referrerPageCategory");
    removeAdobeCookie("referrerPageCode");
  }
  if(!isExitLink && !isDownload && linkObject){
    var linkClicked = linkObject;
    if(typeof(s.linkType) != "undefined" && linkClicked && _satellite){     
      s.linkType = "";
      if(linkClicked.href != "" && linkClicked.href != document.URL && linkClicked.href.indexOf("javascript:") == -1 && linkClicked.href.indexOf("#") != 0 && linkClicked.href.indexOf(document.URL + "#") != 0){
        if(typeof digitalData != "undefined" && typeof digitalData.pageInfo != "undefined" && typeof digitalData.pageInfo.pageCategory != "undefined"){
          setAdobeCookie("referrerPageCategory", digitalData.pageInfo.pageCategory);
        }else{
          removeAdobeCookie("referrerPageCategory");
        }
        if(typeof digitalData != "undefined" && typeof digitalData.pageInfo != "undefined" && typeof digitalData.pageInfo.pageCodeID != "undefined"){
          setAdobeCookie("referrerPageCode", digitalData.pageInfo.pageCodeID);
        }else{
          removeAdobeCookie("referrerPageCode");
        }
		if(typeof digitalData != "undefined" && typeof digitalData.pageInfo != "undefined" && typeof digitalData.pageInfo.pageType != "undefined"){
		  setAdobeCookie("referrerPageType", digitalData.pageInfo.pageType);
		}else{
		  removeAdobeCookie("referrerPageType");
		}		
      }
    }
  }
  ...
  /* Clean up eVar15 */
  if(s.eVar15) {
    s.eVar15=s.eVar15.replace('"','').replace('"','');
  }
  
  /* Visitor ID value in cookie */
  var expiry=new Date();
        expiry.setMonth(expiry.getMonth() + 12);
  if(s.eVar15) s.c_w('eVar15Cookie',s.eVar15,expiry);
  else if(s.c_r('eVar15Cookie') != "") s.eVar15 = s.c_r('eVar15Cookie');
 
 /*FTF Takeover Wrapper -Remove If condition Post Event, leave else condition */
if(typeof digitalData.pageInfo!='undefined' && typeof digitalData.pageInfo.pageLoadRule!='undefined' && digitalData.pageInfo.pageLoadRule=='FTFTakeover'){
	if(typeof digitalData.pageInfo.ftfURL!='undefined'){
		if(digitalData.pageInfo.ftfURL.indexOf("cid=") > -1){
			s.pageURL = digitalData.pageInfo.ftfURL;
		}
		else{
			s.pageURL = s.pageURLTemp;
		}
	}
}else{
	if(s.pageURLTemp){
...
/*FTF Takeover Wrapper -Remove Post Event */  
  ...
  /* Server value on eVar */
  s.server = document.location.hostname;
  //s.eVar60 = s.server;
  
  /* Resetting s.plugins to reduce image URL length */
  s.plugins = "";

  /* Clearing Tab Name when Page Actions is set */
  if(s.eVar57) s.prop12="";
