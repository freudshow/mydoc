  ...
  var tpl ='\<div id="csdn-toolbar" class="csdn-toolbar tb_disnone '+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix">\
            ...
            <li class="tb_is1260hide"><a href="//download.csdn.net/vip_code" title="下载VIP" target="_blank">VIP</a></li>\
            ...
            <a href="javascript:;"class="show-more-a"><svg width="22" height="4" xmlns="http://www.w3.org/2000/svg"><path d="M2 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm9 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm9 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" fill="#4F4F4F" fill-rule="evenodd"/></svg></a>\
              <div class="more">\
                <div class="tb_is1260show"><a href="//download.csdn.net/vip_code" target="_blank">下载VIP</a></div>\
                <div class="tb_is1320show"><a href="//huiyi.csdn.net/" target="_blank">活动</a></div>\
                <div class="tb_is1380show"><a href="http://job.csdn.net" target="_blank">招聘</a></div>\
                <div class="tb_is1440show"><a href="http://www.iteye.com" target="_blank">ITeye</a></div>\
                <div class="tb_is1440show"><a href="http://www.csto.com" target="_blank">CSTO</a></div>\
              </div>\
            </li>\
          </ul>\
