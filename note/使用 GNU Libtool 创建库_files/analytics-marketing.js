...
/******/ 	return __webpack_require__(__webpack_require__.s = "./client-src/bluemix-analytics/js/analytics-marketing.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./client-src/bluemix-analytics/js/analytics-marketing.js":
/*!****************************************************************!*\
  !*** ./client-src/bluemix-analytics/js/analytics-marketing.js ***!
  \****************************************************************/
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(global) {\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ \"./node_modules/@babel/runtime/helpers/interopRequireDefault.js\");\n\nvar _promise = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/core-js/promise */ \"./node_modules/@babel/runtime/core-js/promise.js\"));\n\nvar _extends2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/extends */ \"./node_modules/@babel/runtime/helpers/extends.js\"));\n\nvar _objectWithoutProperties2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/objectWithoutProperties */ \"./node_modules/@babel/runtime/helpers/objectWithoutProperties.js\"));\n\nvar _objectSpread2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/objectSpread */ \"./node_modules/@babel/runtime/helpers/objectSpread.js\"));\n\nvar _metaCategory = _interopRequireDefault(__webpack_require__(/*! ./modules/meta-category */ \"./client-src/bluemix-analytics/js/modules/meta-category.js\"));\n\nvar _stubs = _interopRequireDefault(__webpack_require__(/*! ./utils/stubs */ \"./client-src/bluemix-analytics/js/utils/stubs.js\"));\n\nvar _ready = _interopRequireDefault(__webpack_require__(/*! ./utils/ready */ \"./client-src/bluemix-analytics/js/utils/ready.js\"));\n\nvar _tealiumDataLayerReady = __webpack_require__(/*! ./modules/tealium-data-layer-ready */ \"./client-src/bluemix-analytics/js/modules/tealium-data-layer-ready.js\");\n\nvar logger = __webpack_require__(/*! js-logger */ \"./node_modules/js-logger/src/logger.js\").get(\"BluemixAnalytics:bluemix-analytics:js:analytics-marketing\");\n\n/*\n Analytics hooks for Atlas - Bluemix\n\n Precondition: This file should only be loaded by the main bluemix analytics library.\n */\n(function runMarketingAnalytics() {\n  var getLocation = _stubs.default.getLocation;\n  var loc = getLocation();\n\n  function setPageContextIfAutoPageEventIsEnabled(cat, name, props) {\n    var context = (0, _objectSpread2.default)({}, props, {\n      category: cat,\n      name: name\n    }); // Sets the pageContext which can later be used by track events\n\n    var pushContext = global.bluemixAnalytics._pushContext;\n\n    if (pushContext) {\n      pushContext(context);\n    } else {\n      console.warn('pushContext not defined. Cannot set page category.'); // eslint-disable-line\n    }\n  }\n\n  function getPageAttributes() {\n    // Categories for pages on softlayer.com. Will override meta tags or digitaldata.\n    //   Checkout - /store/completeOrder\n    //   Quote Created - /Store/completedOrderReceipt, /Store/completedPayPalOrderReceipt\n    //   Checkout Completed - /Store/completedOrderReceipt/, /Store/completedPayPalOrderReceipt/ (note the ending slash)\n    //   Configure - /store/*,  /cloud-computing/bluemix/Store/*\n    //   Corporate - /EVENTS, /PRESS, /CAREERS, /LEGAL, /about-SoftLayer, /contact\n    //   Docs - knowledgelayer.softlayer.com\n    //   Support - /support, /resources\n    //   Partner - /referral-program, /reseller-program, /solution-provider-program, /reseller-hosting\n    //   Marketing - everything else on the domain\n    var softlayerDomain = 'softlayer.com';\n\n    if (loc) {\n      var currentPath = loc.pathname;\n      var currentDomain = loc.hostname;\n\n      if (currentDomain.match(/knowledgelayer.softlayer.com$/i)) {\n        return {\n          category: \"Docs (\".concat(softlayerDomain, \")\")\n        };\n      } else if (currentDomain.match(/(www|manage)\\.softlayer\\.com$/i)) {\n        var category = \"Marketing (\".concat(softlayerDomain, \")\");\n\n        if (currentPath.match(/^(\\/cloud-computing\\/bluemix)?\\/Store\\/(completeOrder|completeQuote).*/i)) {\n          category = \"Checkout (\".concat(softlayerDomain, \")\");\n        } else if (currentPath.match(/^(\\/cloud-computing\\/bluemix)?\\/Store\\/(completedOrderReceipt\\/|completedPayPalOrderReceipt\\/).*/i)) {\n          // eslint-disable-line max-len\n          category = \"Checkout Completed (\".concat(softlayerDomain, \")\");\n        } else if (currentPath.match(/^(\\/cloud-computing\\/bluemix)?\\/Store\\/(completedOrderReceipt|completedPayPalOrderReceipt)/i)) {\n          // eslint-disable-line max-len\n          category = \"Quote Created (\".concat(softlayerDomain, \")\");\n        } else if (currentPath.match(/^(\\/cloud-computing\\/bluemix)?\\/Store/i)) {\n          category = \"Configure (\".concat(softlayerDomain, \")\");\n        } else if (currentPath.match(/^\\/(events|press|careers|legal|about-SoftLayer|contact)/i)) {\n          category = \"Corporate (\".concat(softlayerDomain, \")\");\n        } else if (currentPath.match(/^\\/(support|resources)/i)) {\n          category = \"Support (\".concat(softlayerDomain, \")\");\n        } else if (currentPath.match(/^\\/(referral-program|reseller-program|solution-provider-program|reseller-hosting).*/i)) {\n          // eslint-disable-line max-len\n          category = \"Partner (\".concat(softlayerDomain, \")\");\n        }\n\n        return {\n          category: category\n        };\n      } else if (currentDomain.match(/ibm\\.com$/i)) {\n        if (currentPath.match(/^\\/cloud-computing\\/bluemix\\/bare-metal-search/i)) {\n          return {\n            category: 'Product (IBM.com)',\n            subCategory: 'bare metal servers'\n          };\n        }\n      }\n    }\n\n    return {};\n  }\n\n  function addGettingStartedTags(props) {\n    var gsCategory = 'Getting Started';\n    var gsSub = 'Cloud Foundry - Node';\n    setPageContextIfAutoPageEventIsEnabled(gsCategory, \"\".concat(gsCategory, \" - \").concat(gsSub), (0, _objectSpread2.default)({\n      subCategory: gsSub\n    }, props));\n  } // Generate page tag\n\n\n  function atlasPageView(defaultCategory, defaultName, props) {\n    // Figure out the name, category, etc. for a segment 'page' call\n    var _Object$assign = (0, _extends2.default)({}, (0, _objectSpread2.default)({\n      category: defaultCategory,\n      name: defaultName\n    }, props), getPageAttributes()),\n        categoryResult = _Object$assign.category,\n        nameResult = _Object$assign.name,\n        properties = (0, _objectWithoutProperties2.default)(_Object$assign, [\"category\", \"name\"]);\n\n    setPageContextIfAutoPageEventIsEnabled(categoryResult, nameResult, properties);\n  }\n\n  _promise.default.all([(0, _tealiumDataLayerReady.waitForDataLayerReadyIfBeingChanged)(), new _promise.default(function (resolve) {\n    return (0, _ready.default)(resolve);\n  })]).then(function () {\n    var _metaCategory$pageAtt = _metaCategory.default.pageAttributes(),\n        defaultCategory = _metaCategory$pageAtt.category,\n        defaultName = _metaCategory$pageAtt.name,\n        otherProps = (0, _objectWithoutProperties2.default)(_metaCategory$pageAtt, [\"category\", \"name\"]); // this pageId is for https://github.ibm.com/rossfenrick/Getting-Started-Guides\n\n\n    if (defaultName === 'GETTING STARTED') {\n      addGettingStartedTags(otherProps);\n    } else {\n      atlasPageView(defaultCategory, defaultName, otherProps);\n    }\n  });\n})();\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./client-src/bluemix-analytics/js/analytics-marketing.js?");

/***/ }),

/***/ "./client-src/bluemix-analytics/js/modules/meta-category.js":
/*!******************************************************************!*\
  !*** ./client-src/bluemix-analytics/js/modules/meta-category.js ***!
  \******************************************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(global) {\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ \"./node_modules/@babel/runtime/helpers/interopRequireDefault.js\");\n\nvar _stubs = _interopRequireDefault(__webpack_require__(/*! ../utils/stubs */ \"./client-src/bluemix-analytics/js/utils/stubs.js\"));\n\nvar logger = __webpack_require__(/*! js-logger */ \"./node_modules/js-logger/src/logger.js\").get(\"BluemixAnalytics:bluemix-analytics:js:modules:meta-category\");\n\nfunction pageAttributes() {\n  var location = _stubs.default.getLocation();\n\n  var pageContextProperties = {\n    category: 'Uncategorized',\n    name: location.hostname + location.pathname + location.hash\n  };\n  var meta = document.querySelector('meta[name=segment]');\n\n  if (meta) {\n    var metaValue = meta.getAttribute('value');\n\n    if (metaValue) {\n      pageContextProperties.name = metaValue;\n    }\n\n    var metaProperty = meta.getAttribute('property');\n\n    if (metaProperty) {\n      pageContextProperties.category = metaProperty;\n    }\n\n    var metaProductTitle = meta.getAttribute('productTitle');\n\n    if (metaProductTitle) {\n      pageContextProperties.productTitle = metaProductTitle;\n    }\n\n    var metaProductId = meta.getAttribute('productId');\n\n    if (metaProductTitle) {\n      pageContextProperties.productId = metaProductId;\n    }\n  }\n\n  if (global.digitalData && global.digitalData.page) {\n    var _global$digitalData$p = global.digitalData.page,\n        digitalDataCategory = _global$digitalData$p.category,\n        pageInfo = _global$digitalData$p.pageInfo,\n        appInfo = _global$digitalData$p.appInfo;\n\n    if (digitalDataCategory && digitalDataCategory.primaryCategory) {\n      pageContextProperties.category = digitalDataCategory.primaryCategory;\n    }\n\n    if (appInfo) {\n      if (appInfo.tenantId) {\n        pageContextProperties.tenantId = appInfo.tenantId;\n      }\n\n      if (appInfo.plan) {\n        pageContextProperties.tenantPlan = appInfo.plan;\n      }\n    }\n\n    if (pageInfo) {\n      if (pageInfo.analytics && pageInfo.analytics.category) {\n        pageContextProperties.category = pageInfo.analytics.category;\n      }\n\n      if (pageInfo.pageID) {\n        pageContextProperties.name = pageInfo.pageID;\n      }\n\n      if (pageInfo.productTitle) {\n        pageContextProperties.productTitle = pageInfo.productTitle;\n      }\n\n      if (pageInfo.productId) {\n        pageContextProperties.productId = pageInfo.productId;\n      }\n    }\n  }\n\n  return pageContextProperties;\n}\n\nmodule.exports = {\n  pageAttributes: pageAttributes\n};\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./client-src/bluemix-analytics/js/modules/meta-category.js?");

/***/ }),

/***/ "./client-src/bluemix-analytics/js/modules/tealium-data-layer-ready.js":
/*!*****************************************************************************!*\
  !*** ./client-src/bluemix-analytics/js/modules/tealium-data-layer-ready.js ***!
  \*****************************************************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(global) {\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ \"./node_modules/@babel/runtime/helpers/interopRequireDefault.js\");\n\nvar _promise = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/core-js/promise */ \"./node_modules/@babel/runtime/core-js/promise.js\"));\n\nvar logger = __webpack_require__(/*! js-logger */ \"./node_modules/js-logger/src/logger.js\").get(\"BluemixAnalytics:bluemix-analytics:js:modules:tealium-data-layer-ready\");\n\nvar isIdaStatsScriptBegingLoadedCache = null;\n\nfunction isIdaStatsScriptBegingLoaded() {\n  if (isIdaStatsScriptBegingLoadedCache) {\n    return isIdaStatsScriptBegingLoadedCache;\n  }\n\n  var scripts = document.getElementsByTagName('script');\n  isIdaStatsScriptBegingLoadedCache = Array.prototype.some.call(scripts, function (script) {\n    return /common\\/stats\\/ida_(stats|softlayer)\\.js/.test(script.src);\n  });\n  return isIdaStatsScriptBegingLoadedCache;\n}\n\nvar waitForDataLayerReadyIfBeingChangedCache;\n\nfunction waitForDataLayerReadyIfBeingChanged() {\n  var force = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;\n\n  if (waitForDataLayerReadyIfBeingChangedCache && !force) {\n    return waitForDataLayerReadyIfBeingChangedCache;\n  }\n\n  waitForDataLayerReadyIfBeingChangedCache = new _promise.default(function (resolve) {\n    // if coremetrics has already loaded and the ddo is already updated then immediately resolve\n    if (global.digitalData && global.digitalData.page && global.digitalData.page.isDataLayerReady) {\n      resolve();\n      return;\n    } // coremetrics could be loaded from the script or directly embedded on the page or loaded from some other script\n\n\n    if (global.analytics_config && global.analytics_config.coremetrics || isIdaStatsScriptBegingLoaded()) {\n      // if coremetrics is going to be loaded but it is taking to long then resolve anyways\n      // if coremetrics is going to be loaded but it hasn't loaded yet then we will need to add an event listener to wait for the ddo to be set\n      _promise.default.race([new _promise.default(function (timoutResolve) {\n        global.setTimeout(timoutResolve, 5000);\n      }), new _promise.default(function (datalayerResolve) {\n        var handleDataLayerReady = function handleDataLayerReady() {\n          global.removeEventListener('datalayer_ready', handleDataLayerReady);\n          datalayerResolve();\n        };\n\n        global.addEventListener('datalayer_ready', handleDataLayerReady);\n      })]).then(resolve);\n    } else {\n      // coremetrics is not supposed to be loaded and is not currently being loaded so immediately resolve\n      resolve();\n    }\n  });\n  return waitForDataLayerReadyIfBeingChangedCache;\n}\n\nmodule.exports = {\n  waitForDataLayerReadyIfBeingChanged: waitForDataLayerReadyIfBeingChanged\n};\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./client-src/bluemix-analytics/js/modules/tealium-data-layer-ready.js?");

/***/ }),

/***/ "./client-src/bluemix-analytics/js/utils/ready.js":
/*!********************************************************!*\
  !*** ./client-src/bluemix-analytics/js/utils/ready.js ***!
  \********************************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(global) {\n\nvar logger = __webpack_require__(/*! js-logger */ \"./node_modules/js-logger/src/logger.js\").get(\"BluemixAnalytics:bluemix-analytics:js:utils:stubs\");\n\nmodule.exports = {\n  getLocation: function getLocation() {\n    return global.location;\n  },\n  getQueryParams: function getQueryParams() {\n    return global.location.search;\n  },\n  getDocumentReferrer: function getDocumentReferrer() {\n    return document.referrer;\n  },\n  getBrowserLocale: function getBrowserLocale() {\n    // add browser language\n    return navigator.languages && navigator.languages[0] || // Chrome / Firefox\n    navigator.language // All browsers\n    || navigator.userLanguage || navigator.browserLanguage || navigator.systemLanguage; // IE <= 10\n  },\n  getPerformanceData: function getPerformanceData() {\n    return global.performance || global.mozPerformance || global.msPerformance || global.webkitPerformance || null;\n  },\n  getBrowserConnection: function getBrowserConnection() {\n    return global.navigator.connection || global.navigator.mozConnection || global.navigator.webkitConnection || null;\n  },\n  getPageState: function getPageState() {\n    return document.readyState;\n  }\n};\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./client-src/bluemix-analytics/js/utils/stubs.js?");
